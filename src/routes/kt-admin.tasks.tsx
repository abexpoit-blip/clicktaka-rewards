          ...
          <Field className="sm:col-span-2" label="Reward (৳)">
            <div className="relative">
              ...
              <input type="number" step="0.01" min="0" value={form.reward} onChange={(e) => setForm({ ...form, reward: e.target.value })} required
                className="w-full pl-9 pr-3 py-2.5 bg-background border border-border rounded-xl text-sm font-bold tabular-nums text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-fuchsia-400/30 focus:border-fuchsia-400/50 transition" />
            </div>
          </Field>
          ...
          <Field className="sm:col-span-12" label="URL (optional)">
            <div className="relative">
              ...
              <input value={form.url} onChange={(e) => setForm({ ...form, url: e.target.value })} placeholder="https://example.com/landing"
                className="w-full pl-9 pr-3 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-fuchsia-400/30 focus:border-fuchsia-400/50 transition" />
            </div>
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative flex-1 min-w-[220px]">
          ...
          <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Title / type / URL দিয়ে খুঁজুন..."
            className="w-full pl-9 pr-3 py-2.5 bg-card border border-border rounded-xl text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-fuchsia-400/30 focus:border-fuchsia-400/50 transition" />
        </div>
